-- Migration 012: Send to WRead — inbound capture (email / web / extension).
--
-- Out-of-app channels (email, browser extension) drop a raw payload into
-- `send_inbox`; any WRead client drains it through the normal import
...
-- Per-user inbound email address (the local part of `<address>@send.wread.com`).
