...
```bash
git add apps/wread-app/src/app/reader/utils/readingRuler.ts apps/wread-app/src/__tests__/utils/readingRuler.test.ts
...
```bash
git add apps/wread-app/src/app/reader/components/ReadingRuler.tsx
