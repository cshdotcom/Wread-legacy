 ...
 * content script while the user is signed in at web.wread.com and read by
 * the service worker / popup. We never store the user's password — only the
 * short-lived Supabase access token WRead hands out.
 */

const TOKEN_KEY = 'wreadAccessToken';
const TOKEN_AT_KEY = 'wreadTokenAt';
