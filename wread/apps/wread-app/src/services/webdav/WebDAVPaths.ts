...
/**
 * Layout convention for the WebDAV "WRead" subtree under the user's
...
export const WEBDAV_BASE_DIR = 'WRead';
...
/** Absolute path of the WRead base directory (where library.json lives). */
 ...
 *
 * Re-uses wread's existing `makeSafeFilename` so naming rules are
