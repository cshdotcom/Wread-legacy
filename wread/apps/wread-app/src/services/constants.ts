...
export const DOWNLOAD_READEST_URL = 'https://wread.com?utm_source=wread_web';

export const READEST_WEB_BASE_URL = 'https://web.wread.com';
export const READEST_NODE_BASE_URL = 'https://node.wread.com';
...
const LATEST_DOWNLOAD_BASE_URL = 'https://download.wread.com/releases';
...
export const READEST_PUBLIC_STORAGE_BASE_URL = 'https://storage.wread.com';

export const READEST_OPDS_USER_AGENT = 'WRead/1.0 (OPDS Browser)';
