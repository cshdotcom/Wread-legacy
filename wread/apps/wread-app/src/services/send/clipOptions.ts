 ...
 * background all match WRead's current theme + UI language.
 *
...
export function getClipOptions(_: Translate): ClipOptions {
  ...
  return {
    windowTitle: _('Saving to your WRead library…'),
    overlayTitle: _('Saving to WRead'),
    loadingStatus: _('Loading article…'),
    capturingStatus: _('Capturing article…'),
    savedTitle: _('Saved to WRead'),
    background: bg,
    foreground: fg,
  };
}
