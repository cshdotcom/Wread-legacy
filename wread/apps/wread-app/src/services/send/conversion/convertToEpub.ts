 ...
 *   - The browser extension's service worker (`extensions/send-to-wread`).
...
/**
 * Convert a document WRead cannot open natively into an EPUB. Runs entirely
