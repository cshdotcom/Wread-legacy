// Per-device Send to WRead preferences, stored in localStorage (not synced
// across devices).

const DRAIN_ENABLED_KEY = 'wread-send-drain-enabled';

/**
 * Whether this device should drain the Send to WRead inbox — download,
