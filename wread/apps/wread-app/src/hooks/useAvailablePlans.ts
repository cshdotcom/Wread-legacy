...
const IAP_PRODUCT_IDS = [
  'com.bilingify.wread.monthly.plus',
  'com.bilingify.wread.monthly.pro',
  'com.bilingify.wread.storage.1gb.purchase',
  'com.bilingify.wread.storage.2gb.purchase',
  'com.bilingify.wread.storage.5gb.purchase',
  'com.bilingify.wread.storage.10gb.purchase',
];
