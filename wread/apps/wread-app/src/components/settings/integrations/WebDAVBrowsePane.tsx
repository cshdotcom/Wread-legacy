...
const WebDAVBrowsePane: React.FC<WebDAVBrowsePaneProps> = ({ settings, onAppendSyncLogEntry }) => {
  ...
  // `WRead/books/`, filtered down to those orphan rows, and the
      ...
      <div className='card eink-bordered border-base-200 bg-base-100 overflow-hidden border'>
        {isLoading ? (
          ...
          <ul className='divide-base-200 divide-y'>
            {/* Per-hash subdirectories under WRead/books resolve
            ...
            {displayedEntries.map((entry) => {
              ...
              // Title decoration only kicks in inside WRead/books
