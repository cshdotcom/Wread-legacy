...
import SendToWReadForm from './integrations/SendToWReadForm';
...
const IntegrationsPanel: React.FC = () => {
  ...
  // Readwise, Hardcover, OPDS, Send-to-WRead) is open, intercept and
  ...
  if (subPage === 'send')
    return (
      <div className='my-4 w-full'>
        <SendToWReadForm onBack={() => setSubPage(null)} />
      </div>
    );
