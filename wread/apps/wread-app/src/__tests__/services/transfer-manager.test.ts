...
describe('TransferManager', () => {
  ...
  describe('initialize', () => {
    test('loads persisted queue from localStorage', async () => {
      ...
      localStorage.setItem('wread_transfer_queue', JSON.stringify(data));
  ...
  describe('cancelTransfer', () => {
    ...
    test('persists queue after cancel', async () => {
      ...
      const stored = localStorage.getItem('wread_transfer_queue');
  ...
  describe('pauseQueue / resumeQueue', () => {
    ...
    test('pauseQueue persists state', async () => {
      ...
      transferManager.pauseQueue();
      const stored = JSON.parse(localStorage.getItem('wread_transfer_queue')!);
  ...
  describe('persistence', () => {
    ...
    test('handles corrupted localStorage data gracefully', async () => {
      localStorage.setItem('wread_transfer_queue', 'invalid-json{{{');
