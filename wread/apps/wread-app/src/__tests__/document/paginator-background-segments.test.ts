...
//
// See wread/wread swipe background flash.
...
describe('computeBackgroundSegments', () => {
  ...
  it('keeps a centered page inside its content area (inset > 0)', () => {
    ...
    // outer margin gutters, so the page stays centered (wread#4394).
  ...
  // Regression test for wread/wread#4394. Backgrounds used to bleed into the
...
// Regression test for wread/wread#4399: a background texture mounted on the
