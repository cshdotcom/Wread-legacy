...
vi.mock('@/services/environment', () => ({
  ...
  getBaseUrl: () => 'https://web.wread.com',
  getNodeBaseUrl: () => 'https://node.wread.com',
  isWebDevMode: () => true,
}));
...
describe('opdsReq', () => {
  ...
  describe('getProxiedURL', () => {
    ...
    it('should include serialized custom headers in the proxy URL', () => {
      ...
      const params = new URL(proxied, 'https://web.wread.com').searchParams;
  ...
  describe('fetchWithAuth', () => {
    ...
    it('passes preemptive auth through the proxy URL when useProxy is true', async () => {
      ...
      const auth = new URL(proxyUrl, 'https://web.wread.com').searchParams.get('auth');
