...
{% endfor %}`;
  ...
  describe('Annotation link variants', () => {
      ...
      chapters: [
        {
          ...
          annotations: [
            {
              text: 'quote',
              webLink: 'https://web.wread.com/o/book/abc/annotation/n1',
              appLink: 'wread://book/abc/annotation/n1',
              link: 'https://web.wread.com/o/book/abc/annotation/n1',
            },
          ],
        },
      ],
    ...
    it('should render annotation.webLink', () => {
      ...
      expect(result).toBe('https://web.wread.com/o/book/abc/annotation/n1');
    });

    it('should render annotation.appLink with wread:// scheme', () => {
      const template = '{{ chapters[0].annotations[0].appLink }}';
      const result = renderNoteTemplate(template, linkData);
      expect(result).toBe('wread://book/abc/annotation/n1');
    });
