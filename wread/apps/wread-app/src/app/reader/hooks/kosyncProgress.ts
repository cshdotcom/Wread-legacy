 ...
 * endpoint — report `progress` in formats WRead cannot resolve to a CFI.
 ...
 *
 * KOReader and WRead paginate differently, so the server-reported
 * `percentage` is not directly comparable to WRead's own progress. When the
