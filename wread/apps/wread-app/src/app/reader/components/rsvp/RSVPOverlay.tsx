...
const STORAGE_KEY_FONT_SIZE = 'wread_rsvp_fontsize';
const STORAGE_KEY_ORP_COLOR = 'wread_rsvp_orp_color';
const STORAGE_KEY_CONTEXT = 'wread_rsvp_context';
const STORAGE_KEY_HIGHLIGHT_WORD = 'wread_rsvp_cjk_highlight_word';
