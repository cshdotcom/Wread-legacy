...
pub fn handle_menu_event(app: &AppHandle, event: &MenuEvent) {
    ...
    if event.id() == "open_file" {
        ...
        let _ = opener.open_url("https://wread.com/privacy-policy", None::<&str>);
    } else if event.id() == "report_issue" {
        let _ = opener.open_url("https://github.com/wread/wread/issues", None::<&str>);
    } else if event.id() == "wread_help" {
        let _ = opener.open_url("https://wread.com/support", None::<&str>);
    }
}
