...
//     foliate-js path; in practice WRead's EPUBs aren't encrypted.
// ---------------------------------------------------------------------------
...
<package xmlns="http://www.idpf.org/2007/opf" version="3.0">
  ...
  <manifest>
    ...
    fn partial_md5_short_file_matches_js_reference() {
        ...
        let path = dir.join("wread-epub-parser-test.bin");
...
<package xmlns="http://www.idpf.org/2007/opf" version="3.0">
  ...
  <manifest>
    ...
    fn partial_md5_medium_file_uses_step_windows() {
        ...
        let dir = std::env::temp_dir();
        let path = dir.join("wread-epub-parser-test-medium.bin");
