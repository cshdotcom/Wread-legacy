# wread.koplugin tests

Unit tests for `apps/wread.koplugin/library/` modules. Runs under **LuaJIT
...
1. Write production code at `apps/wread.koplugin/library/foo.lua`.
2. Write `apps/wread.koplugin/spec/library/foo_spec.lua`.
