...
const wreadSrc = path.resolve(__dirname, '../../src');
  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        // tried first.
        '@/services': path.resolve(wreadSrc, 'services'),
        '@/utils': path.resolve(wreadSrc, 'utils'),
        '@/types': path.resolve(wreadSrc, 'types'),
        '@/libs': path.resolve(wreadSrc, 'libs'),
        '@': wreadSrc,
      },
    },
    module: {
