...
const STORAGE_KEY_PREFIX = 'wread_rsvp_wpm_';
const PUNCTUATION_PAUSE_KEY_PREFIX = 'wread_rsvp_pause_';
const POSITION_KEY_PREFIX = 'wread_rsvp_pos_';
const SPLIT_HYPHENS_KEY = 'wread_rsvp_split_hyphens';
const CJK_CHAR_MODE_KEY = 'wread_rsvp_cjk_char_mode';
const START_DELAY_KEY = 'wread_rsvp_start_delay';
