...
export const DATA_SUBDIR = 'WRead';
...
export const DEFAULT_SYSTEM_SETTINGS: Partial<SystemSettings> = {
  ...
  dictionarySettings: {
    providerOrder: [
      'builtin:wiktionary',
      'builtin:wikipedia',
      'wread-builtin-hanying',
      'wread-builtin-oxford',
      'wread-builtin-dict',
      'wread-builtin-xianhan7',
      'wread-builtin-guoyu',
      'wread-builtin-fangyan',
    ],
    providerEnabled: {
      'builtin:wiktionary': true,
      'builtin:wikipedia': true,
      'wread-builtin-hanying': true,
      'wread-builtin-oxford': true,
      'wread-builtin-dict': true,
      'wread-builtin-xianhan7': true,
      'wread-builtin-guoyu': true,
      'wread-builtin-fangyan': true,
    },
  },
...
export const DOWNLOAD_WREAD_URL = 'https://codehub.910500.xyz/cshll/wread';

export const WREAD_WEB_BASE_URL = 'https://web.wread.com';
export const WREAD_NODE_BASE_URL = 'https://node.wread.com';

export const SHARE_BASE_URL = `${WREAD_WEB_BASE_URL}/s`;
export const SHARE_EXPIRATION_DAYS = [1, 3, 7] as const;

// Send to WRead — the domain inbound capture emails are addressed to, the
// R2 bucket holding raw inbound payloads, and the per-user cap on undrained
// inbox items (defense against a leaked address).
export const SEND_EMAIL_DOMAIN = 'wread.com';
export const SEND_INBOX_BUCKET = 'wread-send-inbox';
...
const WREAD_GITEA_API_BASE = 'https://codehub.910500.xyz/api/v1/repos/cshll/wread';

export const WREAD_UPDATER_FILE = `${WREAD_GITEA_API_BASE}/releases/latest`;

export const WREAD_CHANGELOG_FILE = `${WREAD_GITEA_API_BASE}/releases`;

export const WREAD_PUBLIC_STORAGE_BASE_URL = 'https://storage.wread.com';

export const WREAD_OPDS_USER_AGENT = 'WRead/1.0 (OPDS Browser)';
