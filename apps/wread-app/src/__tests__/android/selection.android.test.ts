...
// fixture's exact text. Runs against any adb device/emulator with WRead
...
if (!env) {
  console.warn('[test:android] no adb device with WRead installed — skipping the Android lane');
}
