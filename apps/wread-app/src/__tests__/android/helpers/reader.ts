...
export const APP_PKG = 'com.bilingify.wread';
const CDP_PORT = Number(process.env['WREAD_CDP_PORT'] ?? 9333);
...
// The lane soft-skips unless adb, a device, and an installed WRead app are
