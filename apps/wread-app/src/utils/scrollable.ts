...
const SCROLL_WRAPPER_TOUCH_SCROLL_FLAG = 'data-wread-scroll-wrapper-touch-scroll';
...
/**
 * Capture-phase touch + wheel routing so foliate's paginator and wread's wheel
...
export const applyTableTouchScroll = (document: Document) => {
  ...
  // foliate has no wheel handler, but wread forwards iframe wheel events to
