import posthog from '@/utils/wread-stubs/posthog';

export const TELEMETRY_OPT_OUT_KEY = 'wread-telemetry-opt-out';
export const TELEMETRY_DECISION_KEY = 'wread-telemetry-decision';
