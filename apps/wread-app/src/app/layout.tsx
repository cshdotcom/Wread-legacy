...
const url = 'https://web.wread.com/';
const title = 'WRead — Where You Read, Digest and Get Insight';
const description =
  'Discover WRead, the ultimate online ebook reader for immersive and organized reading. ' +
...
const previewImage = 'https://cdn.wread.com/images/open_graph_preview_read_now.png';
...
export const metadata: Metadata = {
  ...
  keywords: ['epub', 'pdf', 'ebook', 'reader', 'wread', 'pwa'],
  authors: [
    {
      name: 'wread',
      url: 'https://codehub.910500.xyz/cshll/wread',
    },
  ],
  icons: {
