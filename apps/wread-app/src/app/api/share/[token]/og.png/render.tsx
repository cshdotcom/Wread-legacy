  ...
  >
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
        <div style={{ fontSize: 22, color: '#0066cc', fontWeight: 500 }}>Shared via WRead</div>
        <div style={{ fontSize: 18, color: '#a3a3a3' }}>wread.com</div>
      </div>
    </div>
  </div>
);
...
const textOnlyCard = (title: string, author: string | null) => (
  ...
  >
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
      <div style={{ fontSize: 26, color: '#0066cc', fontWeight: 500 }}>Shared via WRead</div>
      <div style={{ fontSize: 20, color: '#a3a3a3' }}>wread.com</div>
    </div>
  </div>
);
