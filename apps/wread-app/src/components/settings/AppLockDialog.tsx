...
export default function AppLockDialog() {
  ...
  const description =
    mode === 'set'
      ? _(
          'Pick a 4-digit PIN. You will need to enter it every time you open WRead. There is no way to recover a forgotten PIN. Clearing the app data is the only way to reset it.',
        )
      : mode === 'change'
